...
void TestChapter2Section1() {
  ...
  Chapter2_DenseLinearProblemsAndDecompositions::
      Section1_LinearAlgebraAndDecompositions::BasicLinearSolving();
  Chapter2_DenseLinearProblemsAndDecompositions::
      Section1_LinearAlgebraAndDecompositions::
          CheckingIfASolutionReallyExists();
  Chapter2_DenseLinearProblemsAndDecompositions::
      Section1_LinearAlgebraAndDecompositions::
          ComputingEigenvaluesAndEigenvectors();
  Chapter2_DenseLinearProblemsAndDecompositions::
      Section1_LinearAlgebraAndDecompositions::ComputingInverseAndDeterminant();
  Chapter2_DenseLinearProblemsAndDecompositions::
      Section1_LinearAlgebraAndDecompositions::LeastSquaresSolving();
  Chapter2_DenseLinearProblemsAndDecompositions::
      Section1_LinearAlgebraAndDecompositions::RankRevealingDecompositions();
  Chapter2_DenseLinearProblemsAndDecompositions::
      Section1_LinearAlgebraAndDecompositions::
          SeparatingTheComputationFromTheConstruction();
}
...
void TestChapter2Section3() {
  ...
  // 其中，SVD分解通常最准确但最慢，正则方程(normal
  // equations)最快但最不准确，QR分解介于两者之间。
  Chapter2_DenseLinearProblemsAndDecompositions::
      Section3_SolvingLinearLeastSquaresSystems::UsingNormalEquations();
  Chapter2_DenseLinearProblemsAndDecompositions::
      Section3_SolvingLinearLeastSquaresSystems::UsingTheQRDecomposition();
  Chapter2_DenseLinearProblemsAndDecompositions::
      Section3_SolvingLinearLeastSquaresSystems::UsingTheSvdDecomposition();
}
void TestChapter2Section4() {
  PrintMsg(4);
  Chapter2_DenseLinearProblemsAndDecompositions::
      Section4_InplaceDecompisitions::InplaceMatrixDecompositions();
}
